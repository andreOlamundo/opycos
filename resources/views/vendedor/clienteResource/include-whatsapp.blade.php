...
<!-- CONTAINER -->
      ...
      <div class="row">
        ...
        <form action="{{ route('cadastro.whatsapp') }}" accept-charset="utf-8">
            {{ csrf_field() }}
            <div class="col-md-4">
              ...
              <input id="phone" type="text" name="cel" minlength="15" maxlength="15" placeholder="+551199999-9999"  class="form-control rounded-0">                  
                ...
                <label for="nome" style="font-size: 15px;">Nome</label>     
                 ...
                 <div class="input-field">
                <input id="email" class="form-control" type="email" title="opycos@opycos.com.br" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="{{ old('email') }}"> 
      ...
      <div class="col-md-10">
                ...
                <div class="input-field">
                    ...
                    <input id="message" type="text" name="msg" value="Gostaria de convida-lo(a) a se cadastrar em nossa plataforma: http://pedidos.opycos.com.br/clientes/whatsapp" class="form-control rounded-0" placeholder="Gostaria de convida-lo(a) a se cadastrar em nossa plataforma: http://pedidos.opycos.com.br/clientes/whatsapp" readonly>
                     <label for="msg" style="font-size: 15px;" >Mensagem</label>
                </div><br> 
        ...
        <div id="console-container" class="col-md-3">
...
const makeLink = function(mode) {
    ...
    let openLink = function() {
        $('#console-container').append(`<b>Link</b>: <a href="${mount()}" target="_blank" class="col px-0"> ${mount()}</a><br><br>`)
    }
    ...
    let openPopUp = function() {
        ...
        $('#console-container').append(`<b>PopUp URL</b>: <a href="${mount()}" target="_blank" class="col px-0"> ${mount()}</a><br><br>`)
    }
