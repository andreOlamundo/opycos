...
@endif       
 @if (session('message-failure'))
          ...
          <form method="post" 
            action="{{route('clientesinter.update', $clientes->id)}}"
        ...
        <div class="col-md-4">
          ...
          <a href="{{route('clientesinter.index')}}" class="btn btn-default" style="margin-top: -20px; width: 130px; height: 25px; padding: 2px 1px; "><!--{{ redirect()->back()->getTargetUrl() }}-->
            <b>Voltar</b>
          </a>
