...
<div id="line-one">
  <div id="line-one">
    ...
    @endif
                ...
                <input class="form-control"  minlength="13" type="tel" title="+55(00)00000-0000 'Campo obrigatário'" maxlength="13" size="8" name="cel" required autofocus />
                ...
                <label for="cel" style="font-size: 15px;">ddd + Celular</label>
                      ...
                      <div class="input-field">        
                <input class="form-control" title="Campo Obrigatário Telefone" onkeypress='mascara( this, mtel );' type="tel"  pattern="\([0-9]{2}\) [0-9]{4,6}-[0-9]{3,4}$" minlength="14" maxlength="14" size="8" name="tel"/>
              ...
              <div class="input-field">
                <input id="email" class="form-control" type="email" title="opycos@opycos.com.br 'Campo obrigatário'" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="{{ old('email') }}" required > 
              ...
              <br>
                    ...
                    <div id="tipo1">
                  <div class="input-field">
                    <input class="form-control" type="text" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" minlength="14" title="Nº CPF no formato 000.000.000-00" name="cpf" onkeypress='mascara(this,mcpf)' maxlength="14" size="8"/>
...
<div class="col-md-1">
      ...
      <input id="login_input_password_new" class="form-control" type="hidden" value="Opycos123" name="password" autocomplete="off">
   
        
      <input id="login_input_password_new" class="form-control" type="hidden" value="Opycos123" name="password_confirmation" autocomplete="off" />
