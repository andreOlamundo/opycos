    ...
    <div class="col">
      <div class="col-md-3">
        ...
        <label style="font-size: 12px;">Desconto
          <input type="text" name="desconto_request" class="percent" readonly  title="Desconto de 1% à 50%" placeholder="0%"> </label> 
        </div>
        <div class="col-md-3">
        ...
        <div class="col">
          ...
          <div class="col-md-3">           
            <label style="font-size: 12px;">Desconto
              <input type="text" name="desconto_produto" class="percent" readonly title="Desconto de 1% à 50%" placeholder="0%"> </label> 
            </div>
            <div class="col-md-3">
              <label style="font-size: 12px;">Qtd
