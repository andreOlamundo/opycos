        ...
        @forelse ($pedidos as $pedido)
                    <!--<div class="col-md-2">
                        ...
                        <div name="op2" class="col-md-5">        
                          ...
                          <label>
                            <input type="checkbox" onclick="myFunction()" name="local" value="{{$freteBoy->local}}" {{ $freteBoy->local == 'Y' ? 'checked' : '' }} /><span style="font-size: 12px;  margin-left: -8px; " title="Alterar endereço de entrega">ALTERAR LOCAL DA ENTREGA</span>
                          </label>
                ...
                function limpa_formulário_cep() {
                        ...
                        $("#cep").blur(function() {
                            ...
                            if (cep != "") {
                                ...
                                <div class="input-field">
                                  <input type="text" pattern="[0-9]{5}-[0-9]{3}" id="cep" value="{{$freteBoy->cep or old('cep') }}" title="Informe o CEP. Consulta automática Ex:00000-000" onkeypress='mascara( this, mcep );' maxlength="9" name="cep" placeholder="Forneça o CEP" />
                                  <label for="cep" style="font-size: 15px;">Cep</label>
                                </div>
                                <div class="input-field">

                                  <input type="text" onkeypress='mascara( this, soLetras );' id="endereço" title="Informe o Endereço" maxlength="191" placeholder="Forneça o endereço" name="endereço" value="{{$freteBoy->endereço or old('endereço') }}"/>
                                  <label for="endereço" style="font-size: 15px;">Endereço</label>
                                </div>
                                <div class="input-field">
                                  <input type="text" onkeypress='mascara( this, mnum );' title="Informe o Número" maxlength="8" name="numero" value="{{$freteBoy->numero or old('numero') }}" placeholder="Forneça o número"/>
                                  <label for="numero" style="font-size: 15px;">Número</label>
                                </div>
                                <div class="input-field">
                                  <input type="text"  id="bairro" title="Informe o Bairro" placeholder="Forneça o Bairro" maxlength="191" name="bairro" value="{{$freteBoy->bairro or old('bairro') }}"/>
                                  <label for="bairro" style="font-size: 15px;">Bairro</label>
                                </div>
                                <div class="input-field">
                                  <input type="text" title="Informe o Complemento" placeholder="Forneça o Complemento" maxlength="12" name="complemento"  value="{{$freteBoy->complemento or old('complemento') }}" />
                                  <label for="complemento" style="font-size: 15px;">Complemento</label>
                                </div>

                                <div class="input-field">
                                  <input type="text" id="cidade" title="Informe a Cidade" maxlength="191" name="cidade"  placeholder="Forneça o nome da Cidade"  value="{{$freteBoy->cidade or old('cidade') }}"/>
                        ...
                        <label>
                          <input type="checkbox" onclick="myFunction()" name="local"  {{ $freteCorreios->local == 'Y' ? 'checked' : '' }} /><span style="font-size: 12px;  margin-left: -8px; " title="Alterar endereço de entrega">ALTERAR LOCAL DA ENTREGA</span>
                        </label>
...
<form id="updateDetalhesFrete" method="POST" action="{{ route('update.detalhesFrete') }}">
  ...
  <input type="hidden" name="endereço">
