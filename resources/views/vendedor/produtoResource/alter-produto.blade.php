  ...
  <div id="line-one">
    <div class="container"> 
      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">                            
            <li><a href="{{route('productinter.index')}}" id="btn" style="text-decoration: none"><b>Produtos</b></a></li>
            <li><a href="{{route('productinter.create')}}" id="btn" style="text-decoration: none"><b>Cadastro</b></a></li>                  
            <li class="active"><b>Alteração</b></li>
          </ol>                 

          <form method="post" 
          action="{{route('productinter.update', $product->id)}}" 
