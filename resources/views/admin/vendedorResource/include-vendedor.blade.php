    ...
    $('.percent').mask('000%', {reverse: true}).attr('maxlength','4');
              ...
              <div id="tipo1">
                  <div class="input-field">
                    <input class="cpf" type="text" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" minlength="14" title="'Campo obrigatório' 000.000.000-00" name="cpf" onkeypress='mascara(this,mcpf)' value="{{ old('cpf') }}" maxlength="14" placeholder="Cadastro Pessoa Física" />
              ...
              <div class="input-field">        
                <input type="text" title="Comissão%" placeholder="0%" name="comissao" class="percent" value="{{ old('comissao') }}" required />
        ...
        <!-- Adicionando JQuery -->
            ...
            <div class="col-md-4">
              ...
              <div class="input-field">
                <input id="email" type="text" title="'Campo obrigatório' EX: opycos@opycos.com.br" name="email" value="{{ old('email') }}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder="E-mail de acesso" required > 
                <label for="email" style="font-size: 15px;">Email</label>
              </div>
              <div class="input-field">
                <input type="password" name="password" pattern="^(?=.*\d)(?=.*[a-z])(?!.*\s).*$" title="Senha com no mínimo seis caracteres Alfanuméricos (Letras e números)" minlength="6" required placeholder="Senha de acesso" autocomplete="off"> 
