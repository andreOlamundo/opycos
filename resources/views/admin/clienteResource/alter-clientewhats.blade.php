 ...
 @if (Session::has('mensagem-falha'))
    ...
    @endif             
         ...
         @forelse ($clientes as $cliente)
            ...
            <input type="hidden" name="id" value="{{ $cliente->id }}">             
               ...
               <div id="tipo1">
                <div class="input-field">
                  <input type="text" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" minlength="14" title="'Campo obrigatório' 000.000.000-00" name="cpf" class="cpf" value="{{$cliente->cpf or old('cpf') }}" placeholder="Cadastro pessoa física" maxlength="14" autofocus/>
              ...
              <div id="tipo2" style="display:none;">
               <div class="input-field">
                <input type="text" pattern="\d{2}\.\d{3}\.\d{3}/\d{4}-\d{2}" minlength="18" title="'Campo obrigatório' 00.000.000/0000-00" name="cnpj" class="cnpj" value="{{$cliente->cnpj  or old('cnpj') }}" maxlength="18" placeholder="Cadastro nacional pessoa jurídica" />
          ...
          <div class="input-field">        
            <input type="text"pattern="\([0-9]{2}\) [0-9]{4,5}-[0-9]{4,4}$" maxlength="15" minlength="14" title="Digite apenas números!.Caracteres especiais incluídos automaticamente. Ex:(11) 98768-7896 Ex:(71) 8578-3746 - Não é necessario incluir o número '0' Zero, afrente do código de área." class="phone" placeholder="ddd+ celular" style="margin-top: 7px;" name="celInput" value="{{$cliente->celInput or old('celInput') }}" required />
            <label for="cel" style="font-size: 15px; margin-top: 7px;">ddd + Celular</label>
          </div>        


     <div class="input-field">        
            <input title="(00) 1000-0001" class="phone_with_ddd" type="tel"  pattern="\([0-9]{2}\) [0-9]{4,4}-[0-9]{4,4}$" minlength="14" maxlength="14" style="margin-top: 9px;" placeholder="Número do telefone" name="tel" value="{{$cliente->tel or old('tel') }}" />
...
<div class="col-md-4">
  <div class="input-field">
            <input type="text" pattern="[0-9]{5}-[0-9]{3}" id="cep" value="{{$cliente->cep or old('cep') }}" title="Informe o CEP. Consulta automática" class="cep" maxlength="9" name="cep" placeholder="Forneça o cep" required />
        ...
        <blockquote>
         ...
         <div class="input-field">         
          <input id="email" type="email" placeholder="{{ $cliente->email }}" title="'Campo obrigatório' E-mail de acesso" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="{{$cliente->email or old('email')}}" placeholder="E-mail de acesso" required> 
           ...
           <div class="input-field">
          <input type="password" name="password" pattern="^(?=.*\d)(?=.*[a-z])(?!.*\s).*$" title="Senha com no mínimo seis caracteres Alfanuméricos (Letras e números)" minlength="6"autocomplete="off" placeholder="Senha de acesso ao sistema" required> 
   ...
   <button type="submit" 
        class="btn waves-effect waves-light  blue darken-2"><span class="glyphicon glyphicon-floppy-disk"></span><b>
        Salvar</b>
      </button>
      </div>
