...
<script type="text/javascript" >
  ...
  $(document).ready(function() {
    ...
    function limpa_formulário_cep() {
          ...
          <div class="card-panel" style="height: 490px; margin-top: 2px; margin-bottom: 2px; padding: 12px 10px;">
            <div class="row">   
          <form method="post" 
          ...
          {{ csrf_field() }}        
              <div class="col-md-4">           
               ...
               <div class="input-field" style="margin-top: 20px;">
                <select id="vendedor" title="Informe o representante comercial" name="vendedor_id" required="required">
                  @foreach($vendedores as $vendedor)
                  <option value=""></option>
                  <option value="{{ $vendedor->id }}">{{$vendedor->id}}. {{$vendedor->name}} </option>
                  @endforeach     
                </select>
                <label for="vendedor_id" style="font-size: 15px; margin-top: -30px;">Escolha um vendedor</label>
              </div>
      ...
      <div class="col-md-4">   
       ...
       <a href="{{route('clientes.index')}}" style="margin-top: -20px; width: 130px; height: 25px; padding: 2px 1px; " class="btn btn-default">
          <b>Voltar</b>
        </a>
