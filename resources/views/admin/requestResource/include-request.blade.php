     ...
     <div class="row" style="height: 50px; width: 1170px; position: fixed; background-color: white; z-index: 1001; top: 50px; margin-bottom: 70px;">
      <div class="col-md-12">
        ...
        <div class="row" style="height: 50px; width: 1170px; position: fixed; z-index: 1001; top: 100px; ">
            <div class="col-md-12"> 
                       <!--<ol class="breadcrumb">
                        <li><a href="{{route('product.create')}}" id="btn" style="text-decoration: none"><b>Produtos</b></a></li>
                        <li class="active">Requisições</li>
                        <li><a href="{{route('categoria.create')}}" id="btn" style="text-decoration: none"><b>Categorias</b></a></li>
                      </ol>-->
                      ...
                      <div class="card-panel" style="height: 120px; margin-top: 2px; margin-bottom: 2px; padding: 12px 10px;">    
                        <form method="post" 
                          action="{{route('requestopycos.store')}}">
                          {{ csrf_field() }}                 
                        <div class="row">
