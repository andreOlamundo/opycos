...
function salvaDetalhesFrete( idpedido, idlocal, item  ) {
    $('#form-salvar-pedido input[name="pedido_id"]').val(idpedido);
    $('#form-salvar-pedido input[name="local"]').val(idlocal);
    $('#form-salvar-pedido').submit();
}
